...
import { fetchPaymentApprovalInvoices, paymentApprovalApprove, paymentApprovalHold, paymentApprovalReject, paymentApprovalSendBack } from "../api/Service";
...
export default function PaymentApproval() {
  ...
  const pending = invoices.filter(i => i.hodStatus === "Approved" && i.status === "Payment Approval");
    ...
    <div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="card-header">
          ...
          <span style={{ fontSize: 12, color: 'var(--text-muted)' }}>{pending.length} invoices</span>
        </div>
        <div className="table-wrapper">
          <table>
            ...
            <tbody>
              {pending.length === 0 ? (
                <tr><td colSpan={10}><div className="empty-state"><div className="empty-state-icon">✅</div><div className="empty-state-text">No invoices pending payment approval</div></div></td></tr>
              ) : pending.map(inv => {
              ...
              <tbody>
                {approved.map(inv => (
                  <tr key={inv.id}>
                    ...
                    <td><span className={`badge ${inv.paymentStatus === "Processed" ? "badge-green" : "badge-blue"}`}>{inv.paymentStatus || "Pending"}</span></td>
                    <td>
                      <div className="action-row">
          ...
          <div className="modal" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="form-group" style={{ marginTop: 14 }}>
                ...
                <textarea className="form-control" value={formData.remarks} onChange={e => setFormData(p => ({ ...p, remarks: e.target.value }))}
